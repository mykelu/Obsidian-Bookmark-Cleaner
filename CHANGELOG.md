...
### [1.3.2] - 2026-05-04
#### Added
- **Local PDF Intelligence**: Integrated `pdf.js` for browser-side PDF text extraction.
- **Enhanced Document Support**: The "Standard" extraction engine now produces clean markdown for PDF documents without requiring cloud scrapers.
